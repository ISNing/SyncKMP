...
@Composable
fun buildSyncProcessConfigFromPrefs(): SyncProcessConfigInternal {
    val prefs = createDefaultPreferenceFlow().collectAsState().value

    return SyncProcessConfigInternal(
...
@Composable
expect fun buildSyncProcessConfigPlatformDefault(): SyncProcessConfig

@Composable
fun buildSyncProcessConfig(): SyncProcessConfig {
    val fromPrefs = buildSyncProcessConfigFromPrefs()
    val platformDefault = buildSyncProcessConfigPlatformDefault()
